...
imsave("down/seam_img.png", image_out)
col32.image(image_out, use_column_width=True)

st.sidebar.markdown("\n")
st.sidebar.download_button("Atsiųsti sutrauktą nuotrauką", convert_image_for_download("down/seam_img.png"), "img_seam.png", "image/png")
